...
Export_PHP_Autoconf()
{
    export PHP_AUTOCONF=/usr/local/autoconf-2.61/bin/autoconf
    export PHP_AUTOHEADER=/usr/local/autoconf-2.61/bin/autoheader
}
...
Install_PHP_54()
{
    ...
    Tar_Cd ${Php_Ver}.tar.gz ${Php_Ver}
        ./configure --prefix=/usr/local/php --with-config-file-path=/usr/local/php/etc --enable-fpm --with-fpm-user=www --with-fpm-group=www --with-mysql=mysqlnd --with-mysqli=mysqlnd --with-pdo-mysql=mysqlnd --with-iconv-dir --with-freetype-dir=/usr/local/freetype --with-jpeg-dir --with-png-dir --with-zlib --with-libxml-dir=/usr --enable-xml --disable-rpath --enable-bcmath --enable-shmop --enable-sysvsem --enable-inline-optimization --with-curl --enable-mbregex --enable-mbstring --with-mcrypt --enable-ftp --with-gd --enable-gd-native-ttf --with-openssl --with-mhash --enable-pcntl --enable-sockets --with-xmlrpc --enable-zip --with-bz2 --enable-calendar --enable-wddx --with-imap --with-imap-ssl --with-kerberos --enable-exif --enable-soap --with-gettext --disable-fileinfo
...
eof
    ...
    Download_Files ${Download_Mirror}/datebase/phpmyadmin/${PhpMyAdmin_Ver}.tar.gz
